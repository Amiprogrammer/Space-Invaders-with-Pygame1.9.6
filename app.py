...
def main():
    try:
        global pygame,screen,PlayerImg,PlayerX,PlayerY,PlayerX_change,EnemyImg,EnemyX,EnemyY,EnemyX_change,EnemyY_change,num_of_enemies,BulletImg,BulletX,BulletY,BulletY_change,bullet_state,font_score,font_copyright,font_gameover,gameover_img,gameover_status
        ...
        font_gameover = pygame.font.Font("Roboto-Bold.ttf",20)
        ...
        def game_over():
            global gameover_status,gameover_img,font_gameover
            gameover_status = True
            over = font_gameover.render("Press Enter to Restart the Game!", True, (220,220,220))
            screen.blit(gameover_img,(260,140))
            screen.blit(over,(240,365))
    ...
    except pygame.error as pgerror:
        pass
